...
- If a super user logs in or logs out of Archive UI.
- One or more task(s) were canceled or rescheduled or deleted using Monitoring page of Archive UI.
- If any user updates his/her password.
...
.. csv-table:: Participant Object Identification
   ...
   ParticipantObjectDetail, M, 'type=Tasks value=<Base-64 encoded query params used for Cancel/Reschedule/Delete tasks service>'
