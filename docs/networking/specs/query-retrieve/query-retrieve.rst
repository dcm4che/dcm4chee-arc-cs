...
.. table:: Table 4.2.2.3-1.: Proposed Presentation Contexts by the Query/Retrieve Application Entity
   ...
   +-------------------------------+-----------------------------+------------------------------------+-------------------------+------+-----------+
   | | Image Storage SOP Class listed in Table 4.2.2.1-1         | s. :ref:`Table 4.2.2.3-2`                                    | SCU  | None      |
   +-------------------------------------------------------------+--------------------------------------------------------------+------+-----------+
   | | Video Storage SOP Class listed in Table 4.2.2.1-1         | s. :ref:`Table 4.2.2.3-3`                                    | SCU  | None      |
   +-------------------------------------------------------------+------------------------------------+-------------------------+------+-----------+
   | | SR Storage SOP Class listed in Table 4.2.2.1-1            | Implicit VR Little Endian          | 1.2.840.10008.1.2       | SCU  | None      |
   |                                                             +------------------------------------+-------------------------+      |           |
   |                                                             | Explicit VR Little Endian          | 1.2.840.10008.1.2.1     |      |           |
   |                                                             +------------------------------------+-------------------------+      |           |
   |                                                             | Deflated Explicit VR Little Endian | 1.2.840.10008.1.2.1.99  |      |           |
   +-------------------------------------------------------------+------------------------------------+-------------------------+------+-----------+
   | | Other Storage SOP Class listed in Table 4.2.2.1-1         | Implicit VR Little Endian          | 1.2.840.10008.1.2       | SCU  | None      |
   |                                                             +------------------------------------+-------------------------+      |           |
   |                                                             | Explicit VR Little Endian          | 1.2.840.10008.1.2.1     |      |           |
   +-------------------------------------------------------------+------------------------------------+-------------------------+------+-----------+

.. csv-table:: Table 4.2.2.3-2.: Transfer Syntaxes for Image Storage SOP Classes
   :name: Table 4.2.2.3-2
...
.. csv-table:: Table 4.2.2.3-3.: Transfer Syntax for Video Storage SOP Classes
   :name: Table 4.2.2.3-3
   :header: "Transfer Syntax Name", "UID"
...
.. table:: Table 4.2.2.4-1.: Accepted Presentation Contexts of Query/Retrieve Application Entity by default configuration
   ...
   | | Image Storage SOP Class listed in Table 4.2.2.1-1         | s. :ref:`Table 4.2.2.3-2`                                    | SCU  | None         |
   +-------------------------------------------------------------+--------------------------------------------------------------+------+--------------+
   | | Any Video Storage SOP Class listed in Table 4.2.2.1-1     | s. :ref:`Table 4.2.2.3-2`                                    | SCU  | None         |
   +-------------------------------------------------------------+------------------------------------+-------------------------+------+--------------+
   | | SR Storage SOP Class listed in Table 4.2.2.1-1            | Implicit VR Little Endian          | 1.2.840.10008.1.2       | SCU  | None         |
   |                                                             +------------------------------------+-------------------------+      |              |
   |                                                             | Explicit VR Little Endian          | 1.2.840.10008.1.2.1     |      |              |
