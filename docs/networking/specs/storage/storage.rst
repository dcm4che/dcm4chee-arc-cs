...
.. table:: Storage Application C-STORE Response Status Return Reasons
   ...
   +----------------+-------------------------------------------------------+------------+----------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------+
   |                | Rejection Failed - Class Instance Conflict            | A773       | Failed to reject Instance[uid={SOP Instance UID}] - class-instance conflict.                       | Indicates that there was a conflict in SOP Class UIDs of object (between that of the previously    |
   |                |                                                       |            |                                                                                                    | received rejection note and the one referenced in the current rejection note) to be rejected.      |
   +----------------+-------------------------------------------------------+------------+----------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------+
