...
.. csv-table:: UI Permission Attributes (LDAP Object: dcmUiPermission)
    ...
    :ref:`UI Action Parameter(s) <dcmuiActionParam>`",string,"UI Action Parameter Enumerated values: edit, create, delete, export, accessible, visible, merge, upload, reject, restore or recreate.
