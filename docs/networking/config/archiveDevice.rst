...
.. csv-table:: Archive Device Attributes (LDAP Object: dcmArchiveDevice)
    ...
    hl7UseNullValue_"
    "Rejection Note Storage AE title",string,"Title of Archive Application Entity which configured Object Storage is used for storing Rejection Notes generated by IOCM-RS services. If absent, the Object Storage configured for the Archive AE referred in the IOCM-RS request will be used.","
    .. _dcmRejectionNoteStorageAET:

    dcmRejectionNoteStorageAET_"
